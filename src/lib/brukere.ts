 ...
 * og huskes via en varig session.
 *
 * Merk: onboardingen samler også inn for-/etternavn, men disse lagres ikke
 * ennå (krever en databasekolonne som ikke er lagt til). De ignoreres derfor
 * her inntil kolonnene finnes.
 */
