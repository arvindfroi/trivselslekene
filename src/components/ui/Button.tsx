...
const variants = {
  primary: `${base} bg-accent text-white shadow-[0_0_0_1px_rgba(255,255,255,0.08)_inset] hover:brightness-110 hover:shadow-[0_10px_36px_-10px_rgba(22,184,35,0.65)]`,
